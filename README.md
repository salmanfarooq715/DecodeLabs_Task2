# DecodeLabs Task 2 - Student Grade Calculator
...
- Allows entry of multiple subjects and marks
...
4. Enter the student's details and subject marks.
5. Click the calculate button to view the total marks, percentage, and grade.
